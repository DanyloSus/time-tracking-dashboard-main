...
const Section = ({ img, title, time, prevTime, color }: Props) => {
  return (
    ...
    >
      ...
      <div className="absolute bottom-0 left-0 bg-dark-blue w-[100%] h-[199px] pl-[31px] pb-9 pt-[33px] pr-[34px] flex justify-between items-start flex-col rounded-t-2xl hover:bg-[hsl(235,46%,30%)] cursor-pointer transition-colors lg:h-[122px] lg:justify-between">
